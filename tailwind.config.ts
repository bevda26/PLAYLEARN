  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'text-glow': {
          '0%, 100%': { textShadow: '0 0 5px #fde047, 0 0 10px #fde047, 0 0 15px #fde047' },
          '50%': { textShadow: '0 0 10px #fde047, 0 0 20px #fde047, 0 0 30px #fde047' },
        },
        'fade-in': {
      ...
      animation: {
        ...
        'float-up-down': 'float-up-down 4s infinite ease-in-out',
