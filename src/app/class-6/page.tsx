...
async function getKingdoms() {
    ...
    quests.forEach(quest => {
        // Only count quests for this class level
...
export default async function Class6Homepage() {
          ...
          {kingdoms.map(kingdom => (
           ...
           {kingdoms.length === 0 && (
            <div className="sm:col-span-2 lg:col-span-4 text-center text-foreground/80 p-8 bg-black/20 rounded-lg">
                <p>The realms of knowledge for this class are still forming. Check back soon!</p>
            </div>
           )}
        </div>
      </main>
